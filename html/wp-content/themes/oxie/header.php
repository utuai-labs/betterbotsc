...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
    ...
    <body <?php body_class(get_canon_theme_body_classes());?>>
        ...
        <?php 
            ...
            if (!isset($canon_options['maintenance_msg'])) { $canon_options['maintenance_msg'] = "We are busy doing maintenance - please check back later!"; }

            if ( ($canon_options['use_maintenance_mode'] == "checked") && (is_user_logged_in() === false) ) {
                exit("<div class='maintenance_msg'><h1>". $canon_options['maintenance_msg'] ."</h1></div>"); 
            }

<?php 
 ...
 ?>
                    ...
                    <div class="post-component-container post-component-info tc-info-box">

                        <div class="info-box-header">

                            <a href="#" onclick="window.print();return false;" class="tc-info-box-print"><i class="fa fa-print"></i></a>
                            
                            <h3><?php echo wp_kses_post($cmb_post_info_title); ?></h3>
                        ...
                        <?php
                            ...
                            if ($cmb_post_show_info_meta == "checked") {
                                ...
                                for ($i = 0; $i < count($cmb_post_info_meta); $i++) {  
                                    if (!empty($cmb_post_info_meta[$i]['label']) || !empty($cmb_post_info_meta[$i]['text'])) {
                                        printf('<p>%s: <b>%s</b></p>', esc_attr($cmb_post_info_meta[$i]['label']), esc_attr($cmb_post_info_meta[$i]['text']));
                                    }
                                }
                                echo '</div>';
                            }
                            ...
                            if ($cmb_post_show_info_ul == "checked") {
                                ...
                                if (!empty($cmb_post_info_ul_title)) { printf('<h5>%s</h5>', esc_attr($cmb_post_info_ul_title)); }
                            ...
                            if ($cmb_post_show_info_ol == "checked") {
                                ...
                                if (!empty($cmb_post_info_ol_title)) { printf('<h5>%s</h5>', esc_attr($cmb_post_info_ol_title)); }
                            ...
                            if (!empty($cmb_post_info_extra_title) || !empty($cmb_post_info_extra_text)) {
                                ...
                                if (!empty($cmb_post_info_extra_title)) { printf('<h5>%s</h5>', esc_attr($cmb_post_info_extra_title)); }

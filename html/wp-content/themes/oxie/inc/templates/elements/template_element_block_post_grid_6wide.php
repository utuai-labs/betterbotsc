				...
				<div class="col-1-3">
					...
					<?php 
						...
						if (isset($results_query[$this_index])) {
							...
							$post_thumbnail_src = ( wp_get_attachment_image_src(get_post_thumbnail_id($this_post->ID)) ) ? wp_get_attachment_image_src(get_post_thumbnail_id($this_post->ID), 'canon_block_post_grid_6wide') : array(get_template_directory_uri() . "/img/block_grid_default.jpg");

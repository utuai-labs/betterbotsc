	<div class="wrap">
		...
		<h2><?php printf( "%s Settings - %s", esc_attr(wp_get_theme()->Name), esc_attr(__("Help Center", "loc_canon")) ); ?></h2>
...
<!-- 				<div class="tutorial_videos settings_tab" data-tab="tutorial_videos">
 ...
 -->
				<div class="codex settings_tab last_tab" data-tab="codex">
					<?php _e("WordPress Codex", "loc_canon"); ?>
				</div>
		...
		<!-- THEME DOCS -->		
			<div class="theme_docs tab_section">
				...
				<iframe 
					name="theme_docs" 
					src="http://themecanon.net/docs/oxie/" 
					frameborder="0" 
					scrolling="auto" 
					width="100%" 
					height="5000px" 

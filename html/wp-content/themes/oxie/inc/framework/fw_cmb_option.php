...
// 	'slug' 					=> 'cmb_quote_is_tweet',
// 	'checkboxes'			=> array(
// 		'cmb_hide_from_archive'		=> __('Hide from blog', 'loc_oxie_core_plugin'),
// 		'cmb_hide_from_gallery'		=> __('Hide from gallery', 'loc_oxie_core_plugin'),
// 		'cmb_hide_from_popular'		=> __('Hide from popular lists', 'loc_oxie_core_plugin'),
// 	),
// 	'post_id'				=> $post->ID,
// )); 

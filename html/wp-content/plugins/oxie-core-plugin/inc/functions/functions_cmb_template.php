	...
	***************************************/
	...
	<!-- DETAILS -->
		...
		<div class="option_item">
			<label for='cmb_project_client'><?php _e("Client", "loc_oxie_core_plugin"); ?></label><br>
		...
		<div class="option_item">
			...
			<input type='text' id='cmb_project_date' name='cmb_project_date' class='widefat' value='<?php if (!empty($cmb_project_date)) echo esc_attr($cmb_project_date); ?>'>
		</div>

		<div class="option_item">
			<label for='cmb_project_url'>Project URL</label><br>
			<input type='text' id='cmb_project_url' name='cmb_project_url' class='widefat' value='<?php if (!empty($cmb_project_url)) echo esc_url($cmb_project_url); ?>'>
		</div>

		<div class="option_item">
			<label for='cmb_project_excerpt'>Excerpt</label><br>
			<textarea id='cmb_project_excerpt' name='cmb_project_excerpt' class='widefat'><?php if (!empty($cmb_project_excerpt)) echo wp_kses_post($cmb_project_excerpt); ?></textarea>
	...
	<!-- SLIDER -->
		...
		<div id="popup_cmb_slider_options">
			...
			<div class="option_item">
				...
				<textarea id='cmb_slider_cap_text' name='cmb_slider_cap_text' class='widefat'><?php if (!empty($cmb_slider_cap_text)) echo wp_kses_post($cmb_slider_cap_text); ?></textarea>

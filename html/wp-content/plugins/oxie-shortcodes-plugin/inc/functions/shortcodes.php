...
function sc_toggle ($atts, $content) {
	...
	$trigger_class = ($active == "yes") ? "sc_toggle-btn active" : "sc_toggle-btn";
	$content_class = ($active == "yes") ? "sc_toggle-content active" : "sc_toggle-content" ;
...
function sc_lightbox ($atts, $content) {
	...
	$output = "";
	$output .= "<div class='clearfix sc_lightbox'>";
	$output .= do_shortcode($content);
	$output .= "</div>";
...
function sc_1c_lightbox_image ($atts, $content) {
	...
	$output = "";
	$output .= "<a href='$src' class='fancybox' $fancybox_group title='$title'><img src='$src' alt='$title' /></a>";
...
function sc_3c_lightbox_image ($atts, $content) {
	...
	$class = ($last == "yes") ? 'third last' : 'third';
...
function sc_lightbox_media ($atts, $content) {
	...
	$output = "";
	$output .= "<div class='clearfix sc_lightbox_media'>";
	$output .= "<a href='$content' class='fancybox-media fancybox.iframe play' $fancybox_group rel='gallery'><img src='$src' alt='$title' /></a>";
	$output .= "</div>";
...
function sc_quote_slide ($atts, $content) {
	...
	$output .= "<li>";
	$output .= "<blockquote>";
	$output .= sprintf('<span class="quote">%s</span>',do_shortcode(wp_kses_post($content)));
